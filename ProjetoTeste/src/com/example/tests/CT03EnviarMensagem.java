...
public class CT03EnviarMensagem {
  ...
  private final String pathFirefoxDriver = "/home/lucas/eclipse-workspace/geckodriver";
  ...
  public void testCT03EnviarMensagem() throws Exception {
    ...
    driver.findElement(By.name("your-name")).sendKeys("Lucas da Silva Lima");
    driver.findElement(By.name("your-email")).clear();
    driver.findElement(By.name("your-email")).sendKeys("lucassilva996@outlook.com");
